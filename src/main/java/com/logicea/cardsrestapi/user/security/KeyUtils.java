...
public class KeyUtils {
    ...
    private KeyPair _refrechTokenKeyPair;
    ...
    private KeyPair getKeyPair(String publicKeyPath, String privateKeyPath) {
        ...
        if (publicKeyFile.exists() && privateKeyFile.exists()) {
            ...
            if (Arrays.stream(environment.getActiveProfiles()).anyMatch(s -> s.equals("prod"))) {
                throw new RuntimeException("Private and public key files do not exist");
            }
    ...
    private KeyPair getRefreshTokenKeyPair() {
        if (Objects.isNull(_refrechTokenKeyPair)) {
            _refrechTokenKeyPair = getKeyPair(refreshTokenPublicKeyPath, refreshTokenPrivateKeyPath);
        }

        return _refrechTokenKeyPair;
    }
